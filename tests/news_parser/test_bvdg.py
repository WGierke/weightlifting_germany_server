...
class TestBVDG(BlogTestCase):
    ...
    def test_url_parsing_with_picture(self):
        article = BVDGParser.parse_article_from_article_url({"url": "http://www.german-weightlifting.de/letzter-haertetest-countdown-fuer-unser-olympiateam/", "image": ''})
    ...
    def test_url_parsing_with_picture2(self):
        article = BVDGParser.parse_article_from_article_url({"url": "http://www.german-weightlifting.de/erfolgreiches-trainingslager-in-kienbaum-dosb-verabschiedet-olympiakader-bei-sommerfest/", "image": ''})
    ...
    def test_url_parsing_without_picture(self):
        article = BVDGParser.parse_article_from_article_url({"url": "http://www.german-weightlifting.de/olympia-aus-fuer-russische-gewichtheber/", "image": ''})
    ...
    def test_url_parsing_without_picture2(self):
        article = BVDGParser.parse_article_from_article_url({"url": "http://www.german-weightlifting.de/pokal-der-blauen-schwerter-feiert-auch-2016-eine-neuauflage/", "image": ''})
