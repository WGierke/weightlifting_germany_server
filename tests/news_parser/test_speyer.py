...
class TestSpeyer(BlogTestCase):
    ...
    def test_url_parsing_with_picture(self):
        ...
        self.assert_starts_with("Der BVDG zeichnet die „Speyerer“ Julia Schwarzbach und Almir Velagic", article["content"])
    ...
    def test_url_parsing_without_picture(self):
        ...
        self.assert_starts_with("Deutlicher Sieg über Heinsheim – Wesentlich mehr als Chemnitz", article["content"])
        self.assert_ends_with("210 = 390 = 148,0 (3.). (wk)", article["content"])
